    ...
    <div class="w-full h-[72px] flex items-center justify-end gap-4 px-2">
        ...
        <div
            ...
            <?php if ($_SESSION["user"]['rol_id'] == 1) { ?>
                <a
                    href="<?php echo BASE_ROUTE ?>admin"
            ...
            <?php } ?>
            <a
                href="<?php echo BASE_ROUTE ?>profile"
                class="w-full text-center py-2 px-1 font-semibold hover:text-blue-500">
                Perfil
            </a>
            <a
                href="<?php echo BASE_ROUTE ?>logout"
...
<?php } else { ?>
    <div class="w-full flex justify-end">
        <a
            href="<?php echo BASE_ROUTE ?>auth"
            class="w-32 bg-blue-500 rounded-md text-center py-2 px-2 active:bg-blue-600 active:scale-95 hover:bg-blue-600">
            Iniciar sesión
        </a>
    </div>
<?php } ?>
